        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center text-white text-xl shadow-lg shadow-orange-500/20">
                🐉
              </div>
              <div>
            ...
            <div className="flex items-center gap-2">
              <span className="flex items-center gap-1.5 px-3 py-1.5 bg-red-50 rounded-lg text-sm text-red-700 border border-red-100">
                <span className="w-1.5 h-1.5 bg-red-500 rounded-full animate-pulse" />
                🔴 Red
              </span>
              <span className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 rounded-lg text-sm text-blue-700 border border-blue-100">
